...
pub enum EscrowInstruction {
    ...
    /// 1. `[writable]` The Bob's token account for the token they send
    /// 2. `[writable]` The Bob's token account for the token they will receive should the trade go through
